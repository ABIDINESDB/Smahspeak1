...
import SvgDecorations from "@/components/SgvDecoration";
          ...
          <div className="max-w-[85rem] mx-auto px-4 sm:px-6 py-10 sm:py-24">
            <div className="text-center">
              <h1 className="text-4xl sm:text-6xl font-bold text-neutral-700">
                Smash<span className="text-indigo-700">Speak</span>
              </h1>
              <p className="mt-3 text-neutral-900">
                SmashSpeak:Bridging Voices , Connecting Worlds
              </p>

              <div className="mt-7 sm:mt-12 mx-auto max-w-3xl relative">
                <div className="grid gap-4 md:grid-cols-2 grid-cols-1">
                  <div className="relative z-10 p-3 flex flex-col space-x-3 border rounded-lg shadow-lg bg-neutral-500 border-neutral-700 shadow-gray-900/20">
                    <TextArea
                      id="source-language"
                      value={sourceText}
